...
import { View, Text,Image,StyleSheet,Dimensions, Linking, Alert } from 'react-native'
...
class LoginMode extends Component{
    ...
    getAccessToken(responseCode){
        var AccessTokenUrl=wxurl+'oauth2/access_token?appid='+appid+'&secret='+secretID+'&code='+responseCode+'&grant_type=authorization_code';
    ...
    getRefreshToken(refreshtoken){
        var getRefreshTokenUrl=wxurl+'oauth2/refresh_token?appid='+appid+'&grant_type=refresh_token&refresh_token='+refreshtoken;
    ...
    getUserInfo(responseData){
        var getUserInfoUrl=wxurl+'userinfo?access_token='+responseData.access_token+'&openid='+responseData.openid;
        ...
        return(
            <View style={styles.loginMode}>
                ...
                <View style={styles.modes}>
                    ...
                    >
                        <Image style={styles.icon} source={require('../../images/login/login_weixin.png')}/>
                    </TouchableOpacity>
                    <TouchableOpacity
                     ...
                     >
                        <Image style={styles.icon} source={require('../../images/login/login_qq.png')}/>
                    </TouchableOpacity>
                    <TouchableOpacity
                     ...
                     >
                        <Image style={styles.icon} source={require('../../images/login/login_weibo.png')}/>
                    </TouchableOpacity>
                </View>
            </View>
        )
