...
class OwnerHeader extends React.Component{
    ...
    render(){
        ...
        const url="http://www.7uao.com/upload/headimg/" + userInfo.UserId + ".jpg"
        return(
            <View style={styles.header}>
                <Image style={styles.headerimg} source={require('../../images/owner/background.png')}/>
                <View style={styles.menu}>
                    <TouchableOpacity
                     style={styles.search}
                     onPress={()=>{this.searchEvent()}}
                     >
                        <Image style={styles.searchicon} source={require('../../images/owner/iconsearch.png')}/>
                        <Text style={styles.searchText}>搜索向日葵内容</Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                    style={styles.btns}
                    onPress={()=>{this.scanEvent()}}
                    >
                        <Image style={styles.menubtn} source={require('../../images/owner/iconscan.png')}/>
                    </TouchableOpacity>
                    <TouchableOpacity 
                    style={styles.btns}
                    onPress={()=>{this.setEvent()}}>
                        <Image style={styles.menubtn} source={require('../../images/owner/iconset.png')}/>
                    </TouchableOpacity>
                </View>
                <View>
                    <View style={styles.vip}>
                        <Image style={styles.vipicon} source={require('../../images/owner/vip.png')}/>
                        ...
                        <View style={styles.info}>
                            ...
                            <View style={styles.namebg}>
                                ...
                                <View style={styles.scorebg}>
                                    <Image style={styles.scoreicon} source={require('../../images/owner/iconscore.png')}/>
                                    <Text style={styles.score}>阳光：{userInfo.Score}</Text>
    ...
    return(
        ...
        >
            <View style={styles.databox}>
                <Text style={[styles.datacount,{color:props.color}]}>{props.count}</Text>
